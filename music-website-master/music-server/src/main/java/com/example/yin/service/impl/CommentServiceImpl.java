...
public class CommentServiceImpl extends ServiceImpl<CommentMapper, Comment> implements CommentService {
    ...
    public R commentOfSongId(Integer songId) {
        List<Comment> comments = commentMapper.selectList(new QueryWrapper<Comment>().eq("song_id", songId));
        return R.success(null, comments);
    }

    @Override
    public R commentOfSongListId(Integer songListId) {
        List<Comment> comments = commentMapper.selectList(new QueryWrapper<Comment>().eq("song_list_id", songListId));
        return R.success(null, comments);
    }
